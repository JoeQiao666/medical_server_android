...
import com.medical.waste.slideback.SlideBackHelper;
import com.medical.waste.slideback.SlideConfig;
import com.medical.waste.slideback.widget.SlideBackLayout;
import com.medical.waste.ui.activity.SplashActivity;
import com.medical.waste.ui.widget.ThreePointLoadingView;
import com.medical.waste.utils.ActivityUtils;
import com.medical.waste.utils.MeasureUtil;
 ...
 * UpdateDate:<p>
 */
public abstract class BaseBluetoothLeActivity<T extends BasePresenter> extends BluetoothLeActivity implements LifecycleProvider<ActivityEvent>,View.OnClickListener, BaseView {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (mProgressDialog == null) {
                    mProgressDialog = new MaterialDialog.Builder(BaseBluetoothLeActivity.this)
                            .content(content)

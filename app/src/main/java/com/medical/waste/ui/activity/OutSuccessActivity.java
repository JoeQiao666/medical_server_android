...
@ActivityFragmentInject(contentViewId = R.layout.activity_out_success,
        isShowLeftBtn = false,
        toolbarTitle = R.string.out_success)
public class OutSuccessActivity extends BaseActivity{
